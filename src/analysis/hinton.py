...
def hinton(inarray, max_value=None, factor_labels=None, latent_labels=None,
           use_default_ticks=True, fontsize=14, ax=None):
    ...
    ax.set_ylabel('latents', fontsize=fontsize)
    ...
    if latent_labels is not None:
        ax.set_yticks(range(len(latent_labels)))
        ax.set_yticklabels(latent_labels)
